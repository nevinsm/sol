...
unchanged. Persistent agents (envoys, governors, chancellor) fire on autarch
...
AI-driven roles (governor, chancellor) run as persistent Claude sessions
...
See: ADR-0010 (governor), ADR-0011 + ADR-0029 (chancellor).
