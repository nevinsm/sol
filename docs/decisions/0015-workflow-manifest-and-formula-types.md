# ADR-0015: Workflow Manifest and Formula Types
...
4. **Only one formula type.** The manifest schema supports `type = "workflow"`
...
Formulas support three execution modes controlled by formula type and a
`manifest` flag:
