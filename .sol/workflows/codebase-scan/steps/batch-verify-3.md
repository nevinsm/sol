# Batch Verify 3 — Monitoring

Verify findings from the **supervision**, **messaging**, and **observability** analysis steps.
...
- `supervision` — Supervision layer (internal/sentinel/, consul/, prefect/, service/, heartbeat/)
- `messaging` — Messaging systems (internal/broker/, nudge/, inbox/, escalation/)
- `observability` — Observability systems (internal/ledger/, chronicle/, events/, trace/)
...
Write to `batch-verify-3.md` in your output directory.
