...
var docSections = []docSection{
	...
	},
	{
		...
		paths:   []string{"world init", "world list", "world status", "world delete", "world sync"},
	},
	{
		heading: "Dispatch",
	...
	{
		heading: "Agents",
		paths:   []string{"agent create", "agent list", "agent reset"},
	},
	{
	...
	},
	{
		...
		paths:     []string{"forge ready", "forge blocked", "forge claim", "forge release", "forge run-gates", "forge push", "forge mark-merged", "forge mark-failed", "forge create-resolution", "forge check-unblocked"},
	},
	{
		heading: "Messaging",
