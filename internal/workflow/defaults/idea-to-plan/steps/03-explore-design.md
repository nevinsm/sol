...
Consider how to implement the requirements. Evaluate at least two approaches.
...
- Minimal blast radius — fewest files changed, least risk
- Simplicity — the approach that is easiest to implement correctly

When you have a recommended design, advance:
