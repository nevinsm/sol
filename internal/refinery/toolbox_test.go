...
func TestCreateResolutionTask(t *testing.T) {
	...
	rigStore.mrs = []store.MergeRequest{
		{ID: "mr-00000001", WorkItemID: "gt-original1", Branch: "polecat/Toast/gt-original1", Phase: "claimed"},
	}
	...
	mr := &store.MergeRequest{
		...
		Branch:     "polecat/Toast/gt-original1",
		Phase:      "claimed",
	}
...
func TestMarkMergedClosesWorkItem(t *testing.T) {
	rigStore := newMockRigStore()
	rigStore.mrs = []store.MergeRequest{
		{ID: "mr-00000001", WorkItemID: "gt-aaa11111", Branch: "polecat/Toast/gt-aaa11111", Phase: "claimed"},
	}
